# Generated by Powerlevel10k configuration wizard on 2021-04-15 at 16:59 CEST.
...
# 24h time, angled separators, blurred heads, sharp tails, 2 lines, dotted, right frame,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # (( $#branch > 32 )) && branch[25,-13]="…"  # <-- this line
